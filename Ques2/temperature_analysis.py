...
# Define the directory containing the temperature data
...
# Filter the files that match the defined pattern
...
# Calculate the seasonal average temperatures for the entire dataset
